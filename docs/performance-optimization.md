...
**Impact:** Faster queries for large codebases

**Recommendation:**
- Single project: 1 collection (default)
- Multi-project setup: Separate collections per project

**Configuration:**
```yaml
storage:
  chromadb:
    collection_name: "project_name"  # Unique per project
```
...
**Debug:**
1. Check BM25 index built: logs show "BM25 index built"
2. Verify ChromaDB server: `./scripts/chroma-cli.sh status`
