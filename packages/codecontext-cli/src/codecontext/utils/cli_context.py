...
def initialize_command(
    ...
    Raises:
        ...
        ChromaDBConnectionError: If storage initialization fails
    ...
    if project:
        ...
        project_id = ProjectIdentifier.detect(detect_path)

    # Normalize project ID
    project_id = ProjectIdentifier.normalize(project_id)
