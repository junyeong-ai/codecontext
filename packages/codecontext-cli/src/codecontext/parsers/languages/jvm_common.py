...
class JVMCommonParser(BaseCodeParser, NLGeneratorMixin):  # Mixin order is correct
    ...
    def _extract_class(
        ...
        nl_desc = self._generate_class_nl(
            name=name, methods_count=methods_count, docstring=docstring
        )
    ...
    def _extract_interface(
        ...
        docstring = self._extract_javadoc(node, source_bytes)
        nl_desc = self._generate_interface_nl(name=name, docstring=docstring)
    ...
    def _extract_method(
        ...
        nl_desc = self._generate_function_nl(
            name=name, is_constructor=is_constructor, docstring=docstring
        )
