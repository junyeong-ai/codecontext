...
from codecontext.parsers.common.chunkers.chunk_optimizer import optimize_chunks
...
class BaseConfigChunker:
    ...
    def _optimize_chunks(self, chunks: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        return optimize_chunks(
            chunks, self.min_chunk_size, self.MAX_CHUNK_SIZE, self.token_to_char_ratio
        )
